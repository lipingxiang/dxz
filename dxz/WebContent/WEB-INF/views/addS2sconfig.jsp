...
function doSubmit(){
	...
	var upVer = $(":text[name='code']").val();
	if(upVer==""){
		$("#errorTip").show();
		$("#errorText").text("服务器编号必须输入!");
		$('body').scrollTop(0);
		return;		
	}
	...
	var downVer = $(":text[name='websocketURL']").val();
	if(downVer==""){
		$("#errorTip").show();
		$("#errorText").text("WB连接访问地址必须输入!");
		$('body').scrollTop(0);
		return;		
	}
	...
	var downVer = $(":text[name='httpURL']").val();
	if(downVer==""){
		$("#errorTip").show();
		$("#errorText").text("HTTP连接访问地址必须输入!");
		$('body').scrollTop(0);
		return;		
	}
...
<div class="panel panel-default">
	...
	<form class="form-horizontal" id="form1" method="post"  action="addS2sconfig" role="form">
...
<!-- 			<input type="text" class="form-control" id="firstname"  name = "upVer"  > -->
	...
	<div class="form-group" style="clear:both;">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="lastname"  name = "code"  >
		</div>
...
<!-- 	</div> -->
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="lastname"  name = "websocketURL"  >
<%-- 			<label><%=vercontrol.getClientid()%></label> --%>
	...
	<div class="form-group" style="clear:both">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="lastname" name = "httpURL" >
		</div>
	</div>
	...
	<div class="form-group" style="clear:both">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="lastname" name = "sdesc" >
		</div>
	</div>
